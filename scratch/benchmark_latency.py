...
def run_benchmarks():
    ...
    test_cases = [
        ...
        },
        {
            ...
            "question": "Give an example of normalization",
            "history": [{"question": "Explain normalization", "answer": "Database normalization reduces data redundancy."}]
        },
        {
            "name": "TEST 5: Standalone Question",
            "question": "What is deadlock?",
            "history": []
        },
        {
            "name": "TEST 6: Follow-up Question",
            "question": "How can it be prevented?",
            "history": [{"question": "What is deadlock?", "answer": "Deadlock is a condition where set of processes are blocked."}]
        }
    ]

    print("==================================================")
    print("       LATENCY BENCHMARK RESULTS (POST-OPT)       ")
    print("==================================================\n")
    ...
    for tc in test_cases:
        ...
        rewriter_status = "LLM Rewriter Used" if (tc["history"] and is_fu) else "Fast Path (Skipped LLM)"
        ...
        print(f"  Time-To-1st-Token : {t_first_token:.3f}s")
